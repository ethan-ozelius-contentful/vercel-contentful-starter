...
import MoreTutorials from "./more-stories";
  ...
  return (
    <section>
      <div className="mb-8 md:mb-16">
        coverImage && <CoverImage title={title} slug={slug} url={coverImage.fields.file.url} />
      </div>
...
export default async function Page() {
  ...
  const firstTutorial = await getTutorialBySlug('machine-learning-fundamentals-with-python', isEnabled);
  const moreTutorials = await getAllTutorials(5, isEnabled);
  ...
  return (
    <div className="container mx-auto px-5">
      ...
      <MoreTutorials moreTutorials={moreTutorials} />
    </div>
  );
}
